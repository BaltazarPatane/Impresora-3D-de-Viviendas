...
// BALTA
//#define AXIS_RELATIVE_MODES { false, false, false, false } <- con extruder y z
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  // BALTA
  // Solución pulsos
  #define MAX_ARC_SEGMENT_MM      50.0 // (mm) Maximum length of each arc segment
